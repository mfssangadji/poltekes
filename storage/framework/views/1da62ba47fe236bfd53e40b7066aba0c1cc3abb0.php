  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-add" method="post" action="<?php echo e(route('arsip')); ?>" data-parsley-validate class="form-horizontal form-label-left">
          <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\poltekes\resources\views/auths/arsip/modals/form.blade.php ENDPATH**/ ?>