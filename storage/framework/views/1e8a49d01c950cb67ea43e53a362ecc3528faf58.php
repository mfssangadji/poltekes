...
<?php $__env->startSection('content'); ?>
		<input type="hidden" name="jid" id="jid" value="<?php echo e(Request::segment(3)); ?>">
	    <div class="x_panel">
	      <div class="x_title">
	        <h2>Data<small><i><?php echo e(array(1=>"Dosen", 2=>"Tenaga Kependidikan", 3=>"Tenaga Pendukung")[Request::segment(3)]); ?></i></small></h2>
	...
	<!-- modals -->
	<?php echo $__env->make('auths.pegawai.modals.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<!-- end Modals -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auths.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\poltekes\resources\views/auths/pegawai/index.blade.php ENDPATH**/ ?>